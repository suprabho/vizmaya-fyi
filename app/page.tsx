...
.vz .wc{background:var(--ink);padding:28px 24px;min-height:190px;display:flex;flex-direction:column;justify-content:space-between;transition:background .3s}
  ...
  return (
    <div className="vz">
      ...
      <section
        id="top"
        className="cream"
        style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '140px clamp(20px,5vw,48px) 100px', position: 'relative', overflow: 'hidden' }}
      >
      ...
      <section className="dark pad" id="work">
        <div className="rv" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 48, flexWrap: 'wrap', gap: 16 }}>
          <div>
            <div className="kicker" style={{ color: 'var(--teal)', marginBottom: 16 }}>Selected work</div>
            <h2 className="h-d" style={{ fontSize: 'clamp(24px,3.5vw,36px)', color: '#fff', lineHeight: 1.2 }}>Visual essays & data stories</h2>
          </div>
        </div>
        <div className="wg">
          <div className="wc rv"><div><div className="wc-h"><span className="wc-n">#01</span><span className="wc-s soon">Coming Soon</span></div><div className="wc-t">Scrollytelling</div><h3>The Quiet Inflation</h3><p>South Korea&apos;s Strait of Hormuz exposure meets GPU compute repricing. What it means for AI infrastructure costs.</p></div><div className="wc-a">→</div></div>
          <div className="wc rv" data-d="1"><div><div className="wc-h"><span className="wc-n">#02</span><span className="wc-s pub">Published</span></div><div className="wc-t">Visual Essay</div><h3>Deep-Sea Mining & The Mineral Gap</h3><p>The critical mineral supply chain from ocean floor to geopolitical leverage.</p></div><div className="wc-a">→</div></div>
          <div className="wc rv" data-d="2"><div><div className="wc-h"><span className="wc-n">#03</span><span className="wc-s pub">Published</span></div><div className="wc-t">Infographic</div><h3>US vs. China: The NeurIPS Rivalry</h3><p>How the balance of AI research power shifted across 8 years of authorship data.</p></div><div className="wc-a">→</div></div>
          <div className="wc rv" data-d="3"><div><div className="wc-h"><span className="wc-n">#04</span><span className="wc-s pub">Published</span></div><div className="wc-t">Data Story</div><h3>Prediction Markets vs. Polls</h3><p>Which forecasting method got closer to reality? A visual breakdown.</p></div><div className="wc-a">→</div></div>
          <div className="wc rv" data-d="4"><div><div className="wc-h"><span className="wc-n">#05</span><span className="wc-s pub">Published</span></div><div className="wc-t">Reel + Infographic</div><h3>Hollywood&apos;s Production Collapse</h3><p>Peak TV is over. The production decline no one wants to talk about.</p></div><div className="wc-a">→</div></div>
          <div className="wc rv" data-d="5"><div><div className="wc-h"><span className="wc-n">#06</span><span className="wc-s pub">Published</span></div><div className="wc-t">Data Essay</div><h3>EV Charging: The Real Cost</h3><p>The total cost of ownership that marketing materials leave out.</p></div><div className="wc-a">→</div></div>
        </div>
      </section>

      <section className="cream pad" id="about">
