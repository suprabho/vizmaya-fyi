...
Spot helium surged 50-100% in March. Northeast Asia hit **$153/MCF**. Headlines screamed shortage.
...
The real event comes at month 4-6. Contracts come up for renewal. Force majeure triggers renegotiation. If Qatar stays offline, contract prices climb toward $1,000-2,000/MCF — a 2-4x increase on the 98% of the market that actually matters.
...
## Act III: The feedback loop nobody has connected

South Korea makes the chips. That's the story everyone has told.

Here's the story nobody has told.

South Korea also builds the ships that carry the gas that the rest of the world needs to replace Qatar's output.
...
## Act IV: How this reprices a GPU hour in Virginia

Everyone is asking: will Silicon Valley get its chips?

Wrong question. The right question is: at what price?

The answer depends on something most AI companies haven't noticed: the memory crisis was already the biggest cost driver *before* Hormuz.
...
HBM production consumes **3x the wafer capacity** per gigabyte compared to standard DRAM. Every wafer allocated to an HBM stack for an NVIDIA GPU is a wafer denied to a smartphone, a laptop, or a server. Google, Amazon, Microsoft, and Meta placed open-ended orders with memory suppliers — accepting as much supply as available, regardless of cost.

The AI boom was eating its own supply chain.

### The cost transmission: three scenarios

**60-day resolution: +2-4% GPU hour impact.** Stockpiles hold. Helium contracts don't reprice. The Hormuz increment on DRAM pricing is +2-4% — invisible against a 172% pre-existing surge. The crisis actually hitting AI compute costs has nothing to do with the strait. Not yet.

| Cost layer | 60-day impact |
|---|---|
...
**6-month scenario: +12-20% GPU hour impact.** Helium contracts reprice — the 98% starts moving. Korean fabs face utilisation cuts of 10-30% as helium is rationed to the most critical process steps. Energy costs rise 25-35% sustained. The South Korea feedback loop begins to tighten. Now it shows on the chart.

| Cost layer | 6-month impact |
|---|---|
...
**3-5 year force majeure: +30-50% GPU hour impact.** The cost curve shifts permanently. Korean fabs lose their cost advantage to Micron (US-based, no Hormuz exposure). Chinese memory makers accelerate. Korean shipyard dominance erodes as orders migrate to Chinese yards. The competitive map of semiconductor memory reorganises around *energy security*, not just technology.

| Cost layer | 3-5 year impact |
|---|---|
| Helium | New structural price floor |
| Korean energy | +15-20% new normal |
| Petrochemicals | +10-15% sustained |
| Korean fab output | Structural cost advantage lost |
| GPU module | +15-25% |
...
If the cost per GPU hour flattens or reverses, the entire AI industry's margin structure reprices. Not the GPU supply. The GPU *economics*.
...
**Helium pricing:** IMARC Group (March 2026), ChemAnalyst (Q4 2025), Phil Kornbluth via CNBC. Spot vs. contract market structure based on Kornbluth's characterisation of a "long-term contract business" where spot represents a small fraction.

**DRAM and memory pricing:** TrendForce, Counterpoint Research, IDC, Gartner, Samsung earnings disclosures, Team Group GM interview via Tom's Hardware, Wikipedia aggregate of industry reporting on the 2024-present global memory supply shortage.

**South Korea energy and economy:** Carnegie Endowment for International Peace ("The Iran War Is Also Now a Semiconductor Problem"), IEEFA ("Lagging renewables growth in South Korea"), Korea Economic Institute of America ("The Iran War Is Stress-Testing South Korea's Energy Model"), AInvest, Bitget News.

**Shipbuilding:** BusinessKorea (248 vs. 48 carrier deliveries, 2021-2025), VesselsValue (orderbook data, $71.3B backlog).

**Semiconductor supply chain:** USGS 2026 Mineral Commodity Summaries (Qatar at 33.2% of world helium production), Korea International Trade Association (64.7% helium dependency), Counterpoint Research (SK Hynix 62% HBM, Q2 2025), TrendForce, J2 Sourcing, DiscoveryAlert.

**GPU and data centre TCO:** SemiAnalysis, Introl, Lenovo Press, Spheron benchmarks.

**Cost-transmission model:** Directional estimates, not precise forecasts. Actual pass-through depends on contract structures, inventory positions, and competitive dynamics that vary by company. The scenario framework (60-day / 6-month / 3-5 year) is calibrated against available data and acknowledges significant uncertainty at longer durations.
